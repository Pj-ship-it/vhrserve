...
CREATE TABLE `adjust`  (
  ...
  `origin_post` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '原岗位名称',
  `new_post` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '现岗位名称',
  `adjust_reason` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '调薪原因',
  `before_salary` decimal(10, 2) NOT NULL COMMENT '调前工资',
...
-- Records of adjust
-- ----------------------------
INSERT INTO `adjust` VALUES (1, '张三', '111111111111111111', '1', '转正', 'java实习生', 'java工程师', '员工毕业转正', 4000.00, 8000.00, '2022-07-01 23:53:32');
INSERT INTO `adjust` VALUES (2, '李四', '222222222222222222', '2', '转正', '前端实习生', '前端工程师', '员工毕业转正', 3000.00, 7000.00, '2022-04-24 01:44:09');
...
CREATE TABLE `conference`  (
  ...
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '会议状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
